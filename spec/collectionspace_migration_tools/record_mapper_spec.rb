  ...
  let(:org_local_hash) do
    {"config"=>
     {"recordtype"=>"organization",
      ...
      "authority_subtypes"=>
        [{"name"=>"Local", "subtype"=>"organization"}, {"name"=>"ULAN", "subtype"=>"ulan_oa"}],
  ...
  let(:person_ulan_hash) do
    {"config"=>
     {"profile_basename"=>"core",
      ...
      "authority_subtypes"=>
        [{"name"=>"Local", "subtype"=>"person"}, {"name"=>"ULAN", "subtype"=>"ulan_pa"}],
  ...
  let(:taxon_local_hash) do
    {"config"=>
     {"profile_basename"=>"anthro",
      ...
      "authority_subtypes"=>
        [{"name"=>"Local", "subtype"=>"taxon"}, {"name"=>"Common", "subtype"=>"common_ta"}],
